...
TECHSOLVE.PATH = "/TechSolve/acess/pages/attendant/";
TECHSOLVE.RESTPATH = "/TechSolve/acess/rest/";
TECHSOLVE.IMAGESPATH = "/TechSolve/acess/pages/attendant/assets/imgs/";
...
function goPage(name, loadPlace){
	...
	if(name=="register"){
		...
		document.title = "TechSolve | Registrar";
		
	}else if(name=="register/regclient"){
		
		$("#section").removeAttr("style");
		document.title = "TechSolve | Clientes";
	...
	}else if(name=="createos"){
		
		$("#section").removeAttr("style");
		document.title = "TechSolve | Criar O.S.";
		TECHSOLVE.client.getallForSelect();
