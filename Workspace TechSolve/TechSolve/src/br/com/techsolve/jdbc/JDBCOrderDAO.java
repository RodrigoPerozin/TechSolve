...
public class JDBCOrderDAO {
	...
	public boolean cancel(int idOS, String justCancelarOS) {
		...
		String command = "UPDATE ordens_de_servico SET motivo_cancelamento = ?, status = "+ statuses.CANCELED +", data_termino = ? WHERE idordem_servico = ?";
		String dataAtual="";
	...
	public int reproveBudget(int idOS) {
		...
		try {
			...
			String command1 = "UPDATE ordens_de_servico SET status = " + statuses.BUDGET_REP + ", data_termino = ? WHERE idordem_servico = ?";
			String dataAtual="";
	...
	public int reproveNewBudget(int idOS) {
		...
		try {
			...
			String command1 = "UPDATE ordens_de_servico SET status = " + statuses.NEW_PROBLEM_REP + ", data_termino = ? WHERE idordem_servico = ?";
			String dataAtual="";
