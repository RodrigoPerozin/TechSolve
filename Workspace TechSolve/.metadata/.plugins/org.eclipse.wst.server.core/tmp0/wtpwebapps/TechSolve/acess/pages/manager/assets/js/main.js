...
TECHSOLVE.PATH = "/TechSolve/acess/pages/manager/";
TECHSOLVE.RESTPATH = "/TechSolve/acess/rest/";
TECHSOLVE.IMAGESPATH = "/TechSolve/acess/pages/manager/assets/imgs/";
...
function goPage(name, loadPlace){
	...
	}else if(name=="register/reguser"){
	
		document.title = "TechSolve | Funcionários";
